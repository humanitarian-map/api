"""
Django settings for humanitarian_map_api project.
...
SECRET_KEY = '&xm2hzs6xmw-cz-azd0+0+1s4xo^zeg6862wc%af1wql)yf2t='
...
ROOT_URLCONF = 'humanitarian_map_api.urls'
...
WSGI_APPLICATION = 'humanitarian_map_api.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        "NAME": env.get("HUMMAP_DB_NAME", "humanitarianmap")
    }
}
